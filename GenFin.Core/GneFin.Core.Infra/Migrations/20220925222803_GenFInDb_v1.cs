...
{
    public partial class GenFInDb_v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdCostCenter = table.Column<int>(type: "int", nullable: false),
                    IdCategory = table.Column<int>(type: "int", nullable: false),
                    DateStart = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bill_PaymentSource_PaymentSourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Establishment = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false),
                    Installment = table.Column<int>(type: "int", nullable: false),
                    TotalInstallment = table.Column<int>(type: "int", nullable: false),
